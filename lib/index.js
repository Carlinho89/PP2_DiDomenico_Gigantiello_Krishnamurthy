...
function handleFileSelect(evt) {
    ...
    parsedContent = reader.onload = function(e) {
      content = parseGBF(e.target.result);  
      displayGenbank(content);
    }
    reader.readAsText(f);      

}

function displayGenbank(content){
    resetContainers();			
    if(content===null)
        return; 
    ...
    document.getElementById('sequence').innerHTML = addSpans(content.sequence);
    displayFeatures(content.features);
...
module.exports.io =  {};
module.exports.io.genbank = parseGBF;
